    ...
    <div className={styles.sales}>
      <ResponsiveContainer minHeight={360}>
        <ComposedChart data={props.data}>
          ...
          <Bar type='monotone' dataKey='Visitor'  barSize={25} fill={color.blue}/>
          <Line type='monotone' dataKey='Exit Intents' stroke={color.red} strokeWidth={3} dot={{fill: color.red}} activeDot={{r: 5, strokeWidth: 0}} />
          <Line type='monotone' dataKey='Leads Generated' stroke={color.green} strokeWidth={3} dot={{fill: color.green}} activeDot={{r: 5, strokeWidth: 0}} />
        </ComposedChart>
      </ResponsiveContainer>
    </div>
  )
